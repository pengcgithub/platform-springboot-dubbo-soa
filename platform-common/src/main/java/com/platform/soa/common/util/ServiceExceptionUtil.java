package com.platform.soa.common.util;
...
public class ServiceExceptionUtil {
     ...
     * @return 异常
     */
    public static SimpleException exception(Integer code) {
        return new SimpleException(messages.get(code), code.toString());
    }
     ...
     * @return 异常
     */
    public static SimpleException exception(Integer code, Object... params) {
        String message = doFormat(code, messages.get(code), params);
        return new SimpleException(message, code.toString());
    }

    public static SimpleException exception(Integer code, String messagePattern, Object... params) {
